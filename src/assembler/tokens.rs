...
impl AsmToken {
    pub fn name_to_tok(input: &str) -> AsmToken {
        match input {
            ...
            "muli" => AsmToken::Opcode(Rc::new(Opcode::Muli)),
            ...
            "xor" => AsmToken::Opcode(Rc::new(Opcode::Xor)),
            ...
            "mul2" => AsmToken::Opcode(Rc::new(Opcode::Mul2)),
            "div" => AsmToken::Opcode(Rc::new(Opcode::Div)),
            "divi" => AsmToken::Opcode(Rc::new(Opcode::Divi)),
            "mod" => AsmToken::Opcode(Rc::new(Opcode::Mod)),
            "modi" => AsmToken::Opcode(Rc::new(Opcode::Modi)),
